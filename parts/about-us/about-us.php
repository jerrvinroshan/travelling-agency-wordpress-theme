         ...
         <div class="about-us__intro_container">
             ...
             <div class="about-us__info_content_container">
                 <div class="about-us__info_content_wrapper">
                     <img
                         src="<?php echo get_template_directory_uri() ?>/assets/images/about-us/what-we-do.png"
                         alt="What we Do"
...
Well-trained in all aspects of manpower sourcing and study placements, we expertly handle candidate screening, documentation, and the complete recruitment or admission process. Thus we ensure a smooth, transparent, and successful experience for every client.
                 ...
                 <div class="about-us__info_content_wrapper right_image">
                     <img
                         src="<?php echo get_template_directory_uri() ?>/assets/images/about-us/about-us_info.png"
                         alt="who we are"
                         class="about-us__info--img" />
                     <div class="about-us__info_content">
